...
/*
b0-b50 whitebox,b51-b55 redbox,b56-b60 bluebox,b61-b65 yellowbox,b66-b70 greenbox,b71-b86 red blue yellow green house respectively
 */
...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //remove below two for loop these are for testing purposes.
       /* View vs;
        Button bn[]=new Button[57];
        for(int i=0;i<57;i++) {
            bn[i] = new Button(this);
        }
        for(int i=0;i<57;i++)
            alca[3][i].addView(bn[i]);
        View vs;
        ((LinearLayout)findViewById(R.id.b71).getParent()).removeView(vs=findViewById(R.id.b71));
        ((LinearLayout)findViewById(R.id.b01)).addView(vs);

       ((LinearLayout)findViewById(R.id.b72).getParent()).removeView(vs=findViewById(R.id.b72));
        ((LinearLayout)findViewById(R.id.b02)).addView(vs);

        ((LinearLayout)findViewById(R.id.b77).getParent()).removeView(vs=findViewById(R.id.b77));
        ((LinearLayout)findViewById(R.id.b03)).addView(vs);

        ((LinearLayout)findViewById(R.id.b76).getParent()).removeView(vs=findViewById(R.id.b76));
        ((LinearLayout)findViewById(R.id.b04)).addView(vs);*/
        turn();//remove starting double slash this was for testing this has very important role in application.
   }
    ...
    public void tokenCliclableAfterDiceRole() {
        View v = null;
        int n = playerOrderNow[turn];
        checkingn=n;
        eligible=false;
